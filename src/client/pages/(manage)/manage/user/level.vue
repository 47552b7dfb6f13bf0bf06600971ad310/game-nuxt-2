<template>
  <UiContent title="Level" sub="Quản lý cấp độ tài khoản">
    ...
    <UModal v-model="modal.editInfo" preventClose>
      <UForm :state="stateEditInfo" @submit="editInfoAction" class="bg-card rounded-xl p-4">
        <UFormGroup label="Cấp độ">
    ...
    <UModal v-model="modal.editNeed" preventClose>
      <UForm :state="stateEditNeed" @submit="editNeedAction" class="bg-card rounded-xl p-4">
    ...
    <UModal v-model="modal.editLimit" preventClose>
      <UForm :state="stateEditLimit" @submit="editLimitAction" class="bg-card rounded-xl p-4">
