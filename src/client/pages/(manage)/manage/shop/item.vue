...
const getList = async () => {
  try {
    ...
    const data = await useAPI('shop/manage/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('shop/manage/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('shop/manage/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('shop/manage/del', { _id })
