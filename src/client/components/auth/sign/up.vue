<template>
  ...
  >
    ...
    <UiFlex justify="between" class="mt-6">
      <UiText pointer size="sm" color="gray" :disabled="!!loading" @click="emit('in')">Bạn đã có tài khoản ?</UiText>
      <UButton type="submit" :loading="loading" color="gray" class="bg-main-blue border">Xác Nhận</UButton>
    </UiFlex>
  </UForm>
</template>
