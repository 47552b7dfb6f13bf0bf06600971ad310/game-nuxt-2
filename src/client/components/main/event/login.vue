<template>
  <div>
    ...
    <UModal v-model="modal.receive" prevent-close>
      <DataEventReceive :event="stateReceive" @done="doneReceive" @close="modal.receive = false" />
    </UModal>
  </div>
</template>
...
const tab = ref(0)
const tabs = [
  { label: 'Theo Tháng', key: 'login.month' },
  { label: 'Theo Năm', key: 'login.total' },
]
